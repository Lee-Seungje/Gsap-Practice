...
function onClick(){
  cnt++;
  if(cnt == 1){
    alert("함경남도에서 태어난 고인은 광복 이듬해 월남한 뒤 목포에서 미곡 도매상을 하다 6·25 전쟁 때 부산으로 피란을 가 담배를 팔기도 했다. 휴전 후 상경해 서울 용산에서 찐빵 장사로 생계를 꾸렸던 그는 1960년대 후반 무역사업으로 큰 돈을 번 뒤 남산에서 취미로 시작한 배드민턴과 처음 인연을 맺었다. 그는 40년 전인 1977년 동승통상(요넥스코리아의 전신)을 설립해 ＇스완＇이라는 브랜드의 셔틀콕을 제조했다. 고인은 제대로 된 용품 없이는 경기력이 향상될 수 없다는 생각에 라켓, 셔틀콕, 의류 등 개선뿐 아니라 배드민턴 대표팀의 해외 전지훈련을 주선하기도 했다. 1980년대 초반 동승통상은 대한배드민턴협회와 장기 후원 계약을 맺었다. 이를 계기로 재정적인 안정을 확보한 한국 배드민턴은 국제무대에서 비약적으로 성장했다.");}
  else if(cnt == 2){
